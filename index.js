...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬❗❄1�7 𝗪𝗔𝗜𝗧, 𝗹𝗮𝗴𝗶 𝗽𝗿𝗼𝘀𝗲𝘀',
				success: '️❬ ✄1�7 ❄1�7 𝘀𝘂𝗰𝗰𝗲𝘀𝘀 🖤',
				error: {
					stick: 'Yah gagal ;(, coba ulangi ^_^',
					Iv: '𝗠𝗮𝗮𝗳 𝗹𝗶𝗻𝗸 𝘁𝗶𝗱𝗮𝗸 𝘃𝗮𝗹𝗶𝗱☹️'
				},
				only: {
					group: '❬❗❄1�7 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 ',
					ownerG: '❬❗❄1�7 𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 ',
					ownerB: '❬❗❄1�7  𝐑𝐘𝐎𝐍𝐄 𝗢𝗡𝗟𝗬 ',
					admin: '❬❗❄1�7 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 ',
					Badmin: '❬❗❄1�7 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 '
				}
			}
            ...
            case 'bcgc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of groupMembers) {
							client.sendMessage(_.jid, buff, image, {caption: `*〄1�7 𝑹𝒀𝑶𝑩𝑶𝑻 〄1�7*\n*Group* : ${groupName}\n\n${body.slice(6)}`})
						}
						reply('')
					} else {
						for (let _ of groupMembers) {
							sendMess(_.jid, `*〄1�7 𝑹𝒀𝑶𝑩𝑶𝑻 〄1�7*\n*Group* : ${groupName}\n\n${body.slice(6)}`)
						}
          ...
          case 'logowolf':
                ...
                case 'quotemaker':
                 ...
                 case 'nulis': 
				case 'tulis': ini
					if (args.length < 1) return reply('𝐚𝐤𝐮 𝐬𝐮𝐫𝐮𝐡 𝐧𝐮𝐥𝐢𝐬 𝐚𝐩𝐚 𝐤𝐚𝐤?')
					teks = body.slice(7)
					reply(mess.wait)
          ...
          case 'fake':
				...
				case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						buff = await client.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❄1�7 𝘽𝙍𝙊𝘼𝘿𝘾𝘼𝙎𝙏 ❯\n\n${body.slice(4)}`})
						}
						reply('𝙨𝙪𝙘𝙘𝙚𝙨𝙨 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩 ')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❄1�7 𝘽𝙍𝙊𝘼𝘿𝘾𝘼𝙎𝙏 ❯\n\n${body.slice(4)}`)
						}
						reply('𝙨𝙪𝙘𝙘𝙚𝙨𝙨 𝙗𝙧𝙤𝙖𝙙𝙘𝙖𝙨𝙩 ')
					}
					break
       ...
       client.sendMessage(from, 'Tuh nomer owner ku >_<, jangan spam atau ku block kamu',MessageType.text, { quoted: mek} )
          ...
          case 'okick':
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝘀𝗶𝗺𝗶 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶︄1�7')
					} else if (Number(args[0]) === 0) {
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗼𝗻𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝘀𝗶𝗺𝗶 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶️️')
					} else {
          ...
          case 'loli':
				...
				if (!isPublic) return reply(mess.only.public)
					...
					client.sendMessage(from, nye, image, { caption: '�9�7�9�6', quoted: mek })
					break
          case 'ownergrup':
				  case 'ownergroup':
               client.updatePresence(from, Presence.composing) 
           ...
           case 'quran':
				...
				case 'nsfw':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝗻𝘀𝗳𝘄 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶')
					} else if (Number(args[0]) === 0) {
						nsfw.splice(from, 1)
						fs.writeFileSync('./src/nsfw.json', JSON.stringify(nsfw))
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗼𝗻𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝗻𝘀𝗳𝘄 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶︄1�7')
					} else {
						reply(' *Ketik perintah 1 untuk mengaktifkan, 0 untuk menonaktifkan* \n𝗰𝗼𝗻𝘁𝗼𝗵: 𝗻𝘀𝗳𝘄 𝟭')
					}
					break
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗴𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝘄𝗲𝗹𝗰𝗼𝗺𝗲/𝗹𝗲𝗳𝘁 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶︄1�7')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('❄1�7 𝗦𝗨𝗞𝗦𝗘𝗦 ❄1�7 𝗠𝗲𝗻𝗼𝗻𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗳𝗶𝘁𝘂𝗿 𝘄𝗲𝗹𝗰𝗼𝗺𝗲/𝗹𝗲𝗳𝘁 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 𝗶𝗻𝗶︄1�7')
					} else {
